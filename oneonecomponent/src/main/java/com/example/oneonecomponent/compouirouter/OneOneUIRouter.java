package com.example.oneonecomponent.compouirouter;
...
import com.example.oneonecomponent.OneOneActivity;
...
public class OneOneUIRouter implements IComponentRouter {
    ...
    private static final String SHAREHOST = "oneone";
    ...
    public boolean openUri(Context context, Uri uri, Bundle bundle) {
        ...
        if (SHAREHOST.equals(host)) {
            Intent intent = new Intent(context, OneOneActivity.class);
